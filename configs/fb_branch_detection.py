...
train_dataset = dict(
    type='CocoDataset',
    ann_file=data_root + 'train/REbranch_train.json',
    data_prefix=dict(img=data_root + 'train/branch/'),
    metainfo=dict(classes=classes),
)
val_dataset = dict(
    type='CocoDataset',
    ann_file=data_root + 'val/REbranch_val.json',
    data_prefix=dict(img=data_root + 'val/branch/'),
    metainfo=dict(classes=classes),
)
